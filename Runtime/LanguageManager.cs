...
#if UNITY_EDITOR
	protected virtual void Setup() { EditorUtility.SetDirty(this); }
...
public static class LanguageManager
{
	...
	public static bool TryGetAudioClip(string key, out AudioClip audioClip) =>
		TryGetAudioClip(key, nLanguage, out audioClip);
	...
	public static string GetText(string key) => GetText(key, nLanguage);
	...
	public static T GetElementByLanguage<T>(this T[] contents) =>
		nLanguage >= contents.Length ? default : contents[nLanguage];
}